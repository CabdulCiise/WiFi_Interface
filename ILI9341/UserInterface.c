...
void DisplayForecastData(void)
{
    ...
    int scrollLine = 90, heightDelta = 20, index = 0, i = 0, updateLines = 1;
    ...
    {
        ILI_Write_Scroll_String(forecastData[index], dispX, dispY + (index * heightDelta) + (scrollCount * 3), TEXTCOLOR, MAIN_BG, 2, scrollLine);
    }
